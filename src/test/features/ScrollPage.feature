...
#    Then Check "Full Name title" has a "Full Name" text
#    Then Check "Date title" has a "Date" text
#
...
#    Then Enter "џ®њƒ" in "full name" field and check data has entered
#    Then Enter "01/01/2021" in "full name" field and check data has entered
#    Then Enter "00:00:00" in "full name" field and check data has entered
#    Then Enter "11111" in "full name" field and check data has entered
#    Then Enter "Menlo Park" in "full name" field and check data has entered
#
#  Scenario: Date field - enable for entering data
#    Then Enter "џ®њƒ" in "date" field and check data has entered
#    Then Enter "01/01/2021" in "date" field and check data has entered
#    Then Enter "00:00:00" in "date" field and check data has entered
#    Then Enter "11111" in "date" field and check data has entered
#    Then Enter "Menlo Park" in "date" field and check data has entered
#
#  Scenario: Full name field - enable to enter max length
#    # 100 symbols for full name field
#    Then Enter "MenloMenloMenloMenloMenloMenloMenloMenloMenloMenloMenloMenloMenloMenloMenloMenloMenloMenloMenloMenlo" in "full name" field and check data has entered
#    Then Clear "full name" field via delete
#    Then Enter "Menlo Menlo Menlo Menlo Menlo Menlo Menlo Menlo Menlo Menlo Menlo Menlo Menlo Menlo Menlo Menlo Menlo Menlo Menlo Menlo" in "full name" field and check data has entered
#
#  Scenario: Date field - enable to enter max length
#    # 100 symbols for date field
#    Then Enter "MenloMenloMenloMenloMenloMenloMenloMenloMenloMenloMenloMenloMenloMenloMenloMenloMenloMenloMenloMenlo" in "date" field and check data has entered
#    Then Clear "date" field via delete
#    Then Enter "Menlo Menlo Menlo Menlo Menlo Menlo Menlo Menlo Menlo Menlo Menlo Menlo Menlo Menlo Menlo Menlo Menlo Menlo Menlo Menlo" in "date" field and check data has entered
#
#  Scenario: Date field - calendar element has absent
#    Then Click on date field
#    Then Check calendar element has absent
#
#  Scenario: Date field - enable to enter different date formats
#    Then Enter "012/01/2021" in "date" field and check data has entered
#    Then Enter "2021/01/05" in "date" field and check data has entered
#    Then Enter "01/2021/21" in "date" field and check data has entered
#    Then Enter "01/010/2021" in "date" field and check data has entered
#    Then Enter "01/01/21" in "date" field and check data has entered
#    Then Enter "January/01/2021" in "date" field and check data has entered
#    Then Enter "Jan/01/2021" in "date" field and check data has entered
#    Then Enter "Jan 1st, 2021" in "date" field and check data has entered
#
#  Scenario: Scroll page - scroll down to the page bottom
#    Then Scroll page "down" to the page "bottom"
#    Then Check scroll element has been "down" position
#
#  Scenario: Scroll page - scroll up to the page top
#    Then Scroll page "down" to the page "bottom"
#    Then Check scroll element has been "down" position
#    Then Scroll page "up" to the page "top"
#    Then Check scroll element has been "up" position
#
#  Scenario: Scroll page - scroll down to the page middle
#    Then Scroll page "down" to the page "middle"
#    Then Check scroll element has been "middle" position
#
#  Scenario: Scroll page - scroll up to the page middle
#    Then Scroll page "down" to the page "bottom"
#    Then Check scroll element has been "down" position
#    Then Scroll page "up" to the page "middle"
#    Then Check scroll element has been "middle" position
#
#  Scenario: Refresh the page - scroll elements saved its position
#    Then Check scroll element has been "base" position
#    Then Scroll page "down" to the page "bottom"
#    Then Check scroll element has been "down" position
