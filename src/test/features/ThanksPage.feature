...
#
#  Scenario: Success title - displays correcty
#    Then Check success title has a "The form was successfully submitted!" text
#
##functional
#  Scenario: Success title - unselected
#    Then Check "success title" has been unselected
#
#  Scenario: Page title - unselected
#    Then Check "page title" has been unselected
#
#  Scenario: Refresh the page - elements have stayed on last position
#    Then Check success title has a "The form was successfully submitted!" text
#    Then Click on "Refresh" and check "thanks" page has opened
#    Then Check "Thanks" has page title "Thanks for submitting your form"
#    Then Check success title has a "The form was successfully submitted!" text
#
#  Scenario: Backward to the page - elements have stayed on last position
#    Then Check success title has a "The form was successfully submitted!" text
#    Then Click on "Form" and check "form" page has opened
#    Then Click on "Backward" and check "thanks" page has opened
#    Then Check "Thanks" has page title "Thanks for submitting your form"
#    Then Check success title has a "The form was successfully submitted!" text
#
#  Scenario: Forward to the page - elements have stayed on last position
#    Then Check success title has a "The form was successfully submitted!" text
#    Then Click on "Backward" and check "form" page has opened
#    Then Click on "Forward" and check "thanks" page has opened
#    Then Check "Thanks" has page title "Thanks for submitting your form"
#    Then Check success title has a "The form was successfully submitted!" text
#
# #header
