...
#web layout
  ...
  Scenario: Selenium logo - display
    Then Check logo Selenium has displayed correctly

  Scenario: Box - unclickable
    Then Check box has not clickable

  Scenario: Selenium logo - unclickable
    Then Check Selenium logo has not clickable

#functional

  Scenario: Drop logo - success dropping and box title changed
    Then Drop Selenium logo to the box
    Then Check title "Dropped!" has displayed correctly
    Then Check Selenium logo has absent on last place
    Then Check Selenium logo in the box
  ...
  Scenario: Back logo - box saved its state
    ...
    Then Check Selenium logo has absent on last place
    Then Check Selenium logo in the box
    Then Drop Selenium logo tо the last place
  ...
  Scenario: Refresh the page - all elements reset its settings
    ...
    Then Check Selenium logo in the box
    Then Click on "Refresh" and check "dragdrop" page has opened
    Then Check title "Drag the image into the box" has displayed correctly
    Then Check logo Selenium has displayed correctly
    Then Check title "Drop here" has displayed
    Then Selenium logo has standart position
